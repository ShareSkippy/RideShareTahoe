...
import { sendContact } from '@/libs/actions/sendContact';

// 1. Mock the server action
jest.mock('@/libs/actions/sendContact', () => ({
  sendContact: jest.fn(),
}));
...
describe('ContactForm', () => {
  ...
  // 3. Set up a Spy on globalThis.dispatchEvent to track analytics
  beforeEach(() => {
    mockedSendContact.mockClear();
    dispatchEventSpy = jest.spyOn(globalThis, 'dispatchEvent').mockImplementation(jest.fn());
  });
