...
beforeAll(() => {
  ...
  consoleLogSpy = jest.spyOn(console, 'log').mockImplementation(() => {}); // Mock globalThis.URL.createObjectURL

  globalThis.URL.createObjectURL = jest.fn(() => 'mock-object-url');
  globalThis.URL.revokeObjectURL = jest.fn(); // Mock globalThis.Image
