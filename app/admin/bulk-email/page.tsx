...
/**
 * Admin page for sending bulk emails to users.
 * Allows admins to draft and send HTML emails in batches.
 */
export default function BulkEmailPage() {
  ...
  if (authLoading || profileLoading || !profile?.is_admin) {
    return (
                ...
                <div className="mt-4">
                  ...
                  <div className="max-h-40 overflow-y-auto">
                    {results.errors.map((error) => (
                      <div key={error.email} className="text-sm text-red-600 mb-1">
