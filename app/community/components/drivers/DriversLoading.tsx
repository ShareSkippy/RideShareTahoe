...
/**
 * @interface DriversLoadingProps
 * @description Defines the props for the DriversLoading component.
 */
interface DriversLoadingProps {
  /**
 ...
 * for the Drivers Tab list when data is being fetched.
 * @param {DriversLoadingProps} props - The component's props.
 * @returns {JSX.Element} The rendered loading indicator UI.
 */
export const DriversLoading: React.FC<DriversLoadingProps> = ({ itemCount = 6 }) => {
